...
def decode():
    while True:
        input_file = input("Enter the image name (with extension) of the image you wish to open: ")
        try:
    ...
    output_file = input("Enter the filename (with extension) of the file you wish to save: ")
...
def encode():
    colors = []
    while True:
        input_file = input("Enter the filename (with extension) of the file you wish to open: ")
        try:
    ...
    output_file = input("Enter the name (without extension) of the image file you wish to save: ")
